...
vctrs::expect_vector(qPLD(p=c(.1,.7,.5,.9,.4),alpha=2,beta=5), ptype = double(),
                size = 5)
  vctrs::expect_vector(dPLD(x=c(1,2,3,4,5),alpha=2,beta=5), ptype = double(),
                       size = 5)
  vctrs::expect_vector(pPLD(x=c(1,2,3,4,5),alpha=2,beta=5), ptype = double(),
                       size = 5)
  vctrs::expect_vector(rPLD(n=c(1,2,3,4,5),alpha=2,beta=5), ptype = double(),
                       size = 5)
  vctrs::expect_vector(r.pl_auc(x=c(1,2,2,3,1),y=c(1,3,2,4,2,3),
                      init_param=c(alpha1=1,beta1=1,alpha2=1,beta2=1),
  ...
  vctrs::expect_vector(r.pl_auc(x=c(1,2,2,3,1),y=c(1,3,2,4,2,3),
                ...
                size = 1)
  vctrs::expect_vector(r.pl_index(x=c(1,2,2,3,1),y=c(1,3,2,4,2,3),
                    init_param=c(alpha1=1,beta1=1,alpha2=1,beta2=1),
